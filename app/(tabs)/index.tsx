...
const styles = StyleSheet.create({
  ...
  dateChip: { width: 44, height: 64, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  dateChipActive: { backgroundColor: Colors.primary, width: 64, height: 64, borderRadius: 32 },
  ...
  dcNumActive: { color: '#fff', fontSize: 26 },
  ...
  emptyState: { flex: 1, alignItems: 'center', justifyContent: 'flex-end', paddingHorizontal: 32, paddingBottom: 48 },
  emptyCharImg: { width: 300, height: 420, marginBottom: 0 },
