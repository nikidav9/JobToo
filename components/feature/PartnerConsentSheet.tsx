      ...
      <View style={s.overlay}>
        <View style={s.sheet}>
          ...
          <ScrollView style={s.body}>
            <Text style={s.text}>
              Для отклика на выбранную смену JobToo передаст этому получателю:
            </Text>
            <Text style={s.list}>• данные профиля, необходимые для рассмотрения отклика;</Text>
            <Text style={s.list}>• текст отклика и последующие сообщения по этой смене;</Text>
            <Text style={s.list}>• статусы отклика, подтверждения и выполнения смены.</Text>
            <Text style={s.text}>
              Цель передачи — рассмотреть отклик, обеспечить диалог и синхронизировать выполнение смены.
              Получатель обрабатывает данные по своим условиям. Согласие относится только к этой смене.
            </Text>
          </ScrollView>
