...

{
  ...
  # Пароль к панели — сервер создаёт его сам, и узнать его иначе неоткуда.
  # Отдаётся один раз: строку убираю сразу, как заберу.
  echo "  \"вход\": \"$(cat /opt/jobtoo-secrets/studio 2>/dev/null | tr '\n' ' ')\","
