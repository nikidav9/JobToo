...
//
// Пропускаем только чтение и запись таблиц jm_*. Ни служебные схемы, ни
// auth, ни storage через эту дверь не достать.
...
// Только таблицы приложения. Ни auth, ни storage, ни служебные схемы.
if (!preg_match('#^/rest/v1/jm_[a-z0-9_]+(\?|$)#', $path)) {
